...
namespace Compequaler.Tests.Unit.Hash
{
    public class FNV32bAlgorithmTests
    {
        ...
        public void ShouldApplyFNVFast(uint expectedResult, uint hashes, int hashCode)
        ...
        public void ShouldApplyFNV(uint expectedResult, uint hashes, int hashCode)
        ...
        public void ShouldXORFold(int expectedResult, uint hashes)
